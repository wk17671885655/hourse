...
<H1>${houseExt.title}</H1>
  <DIV class=subinfo><fmt:formatDate value="${houseExt.pubdate}" pattern="yyyy-MM-dd hh:mm:ss"></fmt:formatDate></DIV>
<DIV class=houseinfo>
<P>户　　型：<SPAN>${houseExt.tname}</SPAN></P>
<P>面　　积：<SPAN>${houseExt.floorage}<SUP>2</SUP></SPAN></P>
<P>位　　置：<SPAN>${houseExt.dname}${houseExt.tname}</SPAN></P>
